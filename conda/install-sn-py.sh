...
## To Run at NERSC
## bash install-sn-py.sh <pathToExistingCondaInstall> ./sn-py-env-nersc-install-nobuildinfo.yml NERSC
## Note the inclusion of NERSC parameter skips the install of jupyterlab below

## To Run at other sites
## bash install-sn-py.sh <pathToExistingCondaInstall> ./sn-py-env-nersc-install-nobuildinfo.yml
